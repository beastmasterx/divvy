...
final Map<String, String> _translationsEn = {
  ...
  'Enter your choice (1-{}, or Enter for default): ': 'Enter your choice (1-{}, or Enter for default): ',
  'Invalid choice. Please enter a number between 1 and {}.': 'Invalid choice. Please enter a number between 1 and {}.',
  'Invalid input. Please enter a number.': 'Invalid input. Please enter a number.',
  'Input cannot be empty. Please enter a number.': 'Input cannot be empty. Please enter a number.',
  ...
  'Deposits: {} | Expenses: {} | Fund: {}{}': 'Deposits: {} | Expenses: {} | Fund: {}{}',
  ...
  // Settlement
  '\n--- Settlement Plan ---': '\n--- Settlement Plan ---',
  'No settlement transactions needed (all balances already zero).': 'No settlement transactions needed (all balances already zero).',
  '----------------------\n': '----------------------\n',
  ...
  'Utilities (Water & Electricity & Gas)': 'Utilities (Water & Electricity & Gas)',
  'Groceries': 'Groceries',
