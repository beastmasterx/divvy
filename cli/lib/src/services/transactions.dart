...
Future<String> createExpense(
  ...
  final response = await client.transactions
      .createExpenseApiV1TransactionsExpensesPost(expenseCreate: request);
...
Future<String> createDeposit(
  ...
  final response = await client.transactions
      .createDepositApiV1TransactionsDepositsPost(depositCreate: request);
  return response.data?.message ?? 'Success';
}
...
Future<String> createRefund(
  ...
  final response = await client.transactions
      .createRefundApiV1TransactionsRefundsPost(refundCreate: request);
  return response.data?.message ?? 'Success';
}
