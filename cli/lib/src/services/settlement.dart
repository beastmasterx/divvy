...
Future<List<TransactionDisplay>> getSettlementPlan(
  ...
  final response = await client.settlement.getSettlementPlanApiV1SettlementPlanGet(
    periodId: periodId,
  );
...
Future<List<({String memberName, String balanceDescription})>>
  ...
  final response = await client.settlement.getSettlementBalancesApiV1SettlementBalancesGet();
