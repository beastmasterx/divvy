...
def upgrade() -> None:
    ...
    from seeding import seed_categories  # noqa: E402
    ...
    op.create_index("ix_role_permission_role", "role_permissions", ["role"], unique=False)
    ...
    from seeding import seed_role_permissions
...
def downgrade() -> None:
    ...
    op.drop_index("ix_role_permission_role", table_name="role_permissions")
