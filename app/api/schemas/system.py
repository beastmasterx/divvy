...
class SystemMemberInfo(BaseModel):
    ...
    paid_remainder_in_cycle: bool = Field(..., description="Whether the member has paid remainder in cycle")
    period_balance: str = Field(..., description="Period balance description (e.g., 'Is owed $123.45', 'Owes $67.89', or 'N/A')")
