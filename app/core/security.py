...
def hash_password(password: str) -> str:
    ...
    Uses bcrypt with a randomly generated salt to securely hash passwords.
    ...
    Returns:
        Bcrypt hash string containing the salt and hashed password.
        This hash should be stored in the database for password verification.

    Example:
        >>> hashed = hashpw("my_password")
        >>> checkpw("my_password", hashed)
        True
    """
...
def check_password(password: str, hash: str) -> bool:
    ...
    Args:
        ...
        hash: Bcrypt hash string (previously generated by hashpw)

    Returns:
        True if the password matches the hash, False otherwise

    Example:
        >>> stored_hash = hashpw("my_password")
        >>> checkpw("my_password", stored_hash)
        True
        >>> checkpw("wrong_password", stored_hash)
        False
    """
