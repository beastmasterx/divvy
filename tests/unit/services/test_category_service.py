...
class TestCategoryService:
    ...
    def test_get_category_by_id_not_exists(self, db_session: Session):
        ...
        service = CategoryService(db_session)
        result = service.get_category_by_id(99999)
    ...
    def test_get_category_by_name_exists(self, db_session: Session):
        ...
        retrieved = service.get_category_by_name("Unique Category Name")
        assert retrieved is not None
    ...
    def test_get_category_by_name_not_exists(self, db_session: Session):
        ...
        service = CategoryService(db_session)
        result = service.get_category_by_name("Non-existent Category")
        assert result is None
    ...
    def test_create_category(self, db_session: Session):
        ...
        created = service.create_category(CategoryRequest(name="New Category"))
        ...
        retrieved = service.get_category_by_id(created.id)
        assert retrieved is not None
    ...
    def test_update_category(self, db_session: Session):
        ...
        # Update it
        updated = service.update_category(category.id, CategoryRequest(name="Updated Name"))
    ...
    def test_delete_category(self, db_session: Session):
        ...
        # Verify it's gone
        retrieved = service.get_category_by_id(category_id)
