...
class TestUserService:
    ...
    def test_get_user_by_email_exists(self, db_session: Session):
        ...
        retrieved = service.get_user_by_email("unique@example.com")
        assert retrieved is not None
    ...
    def test_update_profile_user_exists(self, db_session: Session):
        ...
        updated = service.update_profile(user_id, request)
    ...
    def test_update_profile_partial_update(self, db_session: Session):
    ...
    def test_update_profile_user_not_exists(self, db_session: Session):
        ...
        with pytest.raises(NotFoundError):
            service.update_profile(99999, request)

    def test_delete_user_exists_no_groups(self, db_session: Session):
    ...
    def test_get_groups_by_user_id(self, db_session: Session):
        ...
        groups = service.get_groups_by_user_id(user.id)
