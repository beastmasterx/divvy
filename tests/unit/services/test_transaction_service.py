...
class TestTransactionService:
    ...
    def test_get_transaction_by_id_not_exists(self, db_session: Session):
        ...
        service = TransactionService(db_session)
        result = service.get_transaction_by_id(99999)
    ...
    def test_get_transactions_by_period_id(self, db_session: Session):
        ...
        period1_transactions = service.get_transactions_by_period_id(period1.id)
    ...
    def test_create_transaction_expense_equal_split(self, db_session: Session):
    ...
    def test_create_transaction_deposit(self, db_session: Session):
    ...
    def test_create_transaction_expense_no_shares_raises_error(self, db_session: Session):
    ...
    def test_create_transaction_deposit_with_shares_raises_error(self, db_session: Session):
    ...
    def test_update_transaction_exists(self, db_session: Session):
        ...
        updated = service.update_transaction(transaction.id, request)
    ...
    def test_update_transaction_not_exists(self, db_session: Session):
        ...
        with pytest.raises(NotFoundError):
            service.update_transaction(99999, request)
    ...
    def test_delete_transaction_exists(self, db_session: Session):
        ...
        # Verify it's gone
        retrieved = service.get_transaction_by_id(transaction_id)
        assert retrieved is None

    def test_calculate_shares_equal_split(self, db_session: Session):
        ...
        shares = service.calculate_shares_for_transaction(transaction.id)
    ...
    def test_calculate_shares_personal_split(self, db_session: Session):
    ...
    def test_calculate_shares_not_expense_returns_empty(self, db_session: Session):
    ...
    def test_calculate_shares_transaction_not_exists(self, db_session: Session):
        """Test calculating shares for non-existent transaction raises NotFoundError."""
        service = TransactionService(db_session)

        with pytest.raises(NotFoundError):
            service.calculate_shares_for_transaction(99999)
