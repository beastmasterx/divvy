...
class TestUserRepository:
    ...
    def test_get_all_users_multiple(self, db_session: Session):
    ...
    def test_get_user_by_id_exists(self, db_session: Session):
        ...
        retrieved = repo.get_user_by_id(user_id)
    ...
    def test_get_user_by_id_not_exists(self, db_session: Session):
        ...
        repo = UserRepository(db_session)
        result = repo.get_user_by_id(99999)
    ...
    def test_get_user_by_email_exists(self, db_session: Session):
        ...
        retrieved = repo.get_user_by_email("unique@example.com")
        assert retrieved is not None
    ...
    def test_delete_user_exists(self, db_session: Session):
    ...
    def test_get_groups_by_user_id(self, db_session: Session):
        ...
        groups = repo.get_groups_by_user_id(user.id)
