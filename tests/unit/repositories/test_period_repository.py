...
class TestPeriodRepository:
    ...
    def test_get_all_periods_empty(self, db_session: Session):
    ...
    def test_get_all_periods_multiple(self, db_session: Session):
    ...
    def test_get_period_by_id_exists(self, db_session: Session):
        ...
        retrieved = repo.get_period_by_id(period_id)
    ...
    def test_get_period_by_id_not_exists(self, db_session: Session):
        ...
        repo = PeriodRepository(db_session)
        result = repo.get_period_by_id(99999)
    ...
    def test_create_period(self, db_session: Session):
        ...
        retrieved = repo.get_period_by_id(created.id)
        assert retrieved is not None
        assert retrieved.name == "New Period"

    def test_update_period(self, db_session: Session):
        ...
        retrieved = repo.get_period_by_id(period.id)
        assert retrieved is not None
        assert retrieved.name == "Updated Name"
        assert retrieved.is_closed is True

    def test_delete_period_exists(self, db_session: Session):
